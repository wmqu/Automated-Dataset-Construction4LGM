...
class AutomaticVerbalizer(Verbalizer):
    ...
    Args:
        ...
        balance (:obj:`book`, optional): whether to perform normalization of unbalanced training dataloader, as Equation (5).
    """
    def __init__(self,
    ...
    def project(self,
        ...
        have no connection to the affnet_model to give (miss-leading) grads.
