...
class GenerationVerbalizer(Verbalizer):
    ...
    Args:
        tokenizer (:obj:`PreTrainedTokenizer`): The tokenizer of the current pre-trained affnet_model to point out the vocabulary.
    ...
    Example:
    To use this verbalizer to train the T5 affnet_model to predict answer and explanation using two masks.
