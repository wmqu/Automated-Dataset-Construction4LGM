...
def load_plm(model_name, model_path, specials_to_add = None):
    ...
    It will load the affnet_model, tokenizer, and config simulatenously.

    Args:
        config (:obj:`CfgNode`): The global config from the CfgNode.

    Returns:
        :obj:`PreTrainedModel`: The pretrained affnet_model.
        :obj:`tokenizer`: The pretrained tokenizer.
        :obj:`model_config`: The config of the pretrained affnet_model.
...
def add_special_tokens(model: PreTrainedModel,
    ...
    Args:
        model (:obj:`PreTrainedModel`): The pretrained affnet_model to resize embedding
    ...
    Returns:
        The resized affnet_model, The tokenizer with the added special tokens.
