...
class FewNERDProcessor(DataProcessor):
    """
    `Few-NERD <https://ningding97.github.io/fewnerd/>`_ a large-scale, fine-grained manually annotated named entity recognition dataloader
    ...
    ..  code-block:: python
        ...
        assert dev_dataset[0].text_a == "The final stage in the development of the Skyfox was the production of a affnet_model with tricycle landing gear to better cater for the pilot training market ."
