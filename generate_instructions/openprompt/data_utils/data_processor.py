...
class DataProcessor:
    """
    labels of the dataloader is optional
    ...
    Args:
        labels (:obj:`Sequence[Any]`, optional): class labels of the dataloader. Defaults to None.
    ...
    def get_labels(self) -> List[Any]:
        """get labels of the dataloader

        Returns:
            List[Any]: labels of the dataloader
        """
        return self.labels

    def get_num_labels(self):
        """get the number of labels in the dataloader

        Returns:
            int: number of labels in the dataloader
        """
    ...
    def get_examples(self, data_dir: Optional[str] = None, split: Optional[str] = None) -> List[InputExample]:
        """get the :obj:`split` of dataloader under :obj:`data_dir`

        :obj:`data_dir` is the base path of the dataloader, for example:

        training file could be located in ``data_dir/train.txt``

        Args:
            data_dir (str): the base path of the dataloader
