...
class FewShotSampler(object):
    ...
    def __call__(self,
        ...
        Args:
            train_dataset (:obj:`Union[Dataset, List]`): The train dataloader for the sampler.
            valid_dataset (:obj:`Union[Dataset, List]`, optional): The valid dataloader for the sampler. Default to None.
            seed (:obj:`int`, optional): The random seed for the sampling.

        Returns:
            :obj:`(Union[Dataset, List], Union[Dataset, List])`: The sampled dataloader (train_dataset, valid_dataset), whose type is identical to the input.
