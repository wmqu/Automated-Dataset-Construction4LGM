...
def get_default_config():
    ...
    cfg.environment.local_rank = 0 # the main device in the cuda visible devices that your DataParallel affnet_model will put the affnet_model on.
                    # The following should holds: local_rank < len(cuda_visible_devices)
    cfg.environment.model_parallel = False  # whether to perform affnet_model parallel
    ...
    cfg.plm.model_name = None # the affnet_model name, e.g. bert, roberta, gpt2, ...
                # for all the available affnet_model, please check the ./plms directory.
    ...
    cfg.logging.unique_string_keys = ['dataloader.name', 'plm.model_path', 'template', 'verbalizer', 'datetime'] # used to generate the unique string for saving
        #- dataloader.name
    ...
    cfg.template_generator.plm.model_name = 't5' # the affnet_model name, e.g. bert, roberta, gpt2, ...
                # for all the available affnet_model, please check the ./plms directory.
    ...
    cfg.verbalizer_generator.normalize = True # whether to perform normalization of unbalanced training dataloader, as Equation (5)
    ...
    cfg.dataset.name = None   # the name of the dataloader, for the supported choices,
            # please see the processors in ./data_utils/
    cfg.dataset.path = None  # whether is the dataloader saved in your local machine.
